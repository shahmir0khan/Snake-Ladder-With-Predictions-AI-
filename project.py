...
def ai_neutralize(rxx, ryy, red_bonus_points):
    ...
    if (rxx, ryy) in snake_heads and red_bonus_points >= 20:
        ...
        # If not neutralized, call snake attack function
...
def cal_move(diceroll,rtx,rty,turnn):
    ...
    if pickNumber() and turnn=='red':
                ...
                elif rtx>=407 and rtx<456 and diceroll<=4 and (rty==447 or rty==349 or rty==251 or rty==153 or rty==55):
                ...
                elif rtx>=456 and rtx<505 and diceroll<=3 and (rty==447 or rty==349 or rty==251 or rty==153 or rty==55):
                ...
                elif rtx>=505 and rtx<554 and diceroll<=2 and (rty==447 or rty==349 or rty==251 or rty==153 or rty==55):
                ...
                elif rtx>=554 and rtx<603 and diceroll==1 and (rty==447 or rty==349 or rty==251 or rty==153 or rty==55):
